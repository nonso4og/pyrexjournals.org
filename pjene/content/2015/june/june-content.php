...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, June 2015 | PJENE </h1>
			<br />
			<h3>Review Paper</h3>
			
			<p style="line-height:20px;">
			<b>Solving the advection diffusion equation in three dimensions in neutral case</b>
			<br />

			Khaled S.M Essa* and S. E. M.  Elsaid
			<br />
			Pyrex Journals Eco. Nat. Env. June 2015 1(1): 001-006 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/june/essa-and-elsaid.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/june/essa-and-elsaid.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
