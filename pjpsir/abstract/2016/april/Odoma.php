...
<title>Democratic practice and development of ethnic militias in Nigeria</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>April 2016 Vol. 2(1), pp. 27-34</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Democratic practice and development of ethnic militias in Nigeria</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Odoma U. Samuel</h1>

			<p>Department of Sociology, Kogi State University, Anyigba, Nigeria.</p>

			<p>Corresponding Author E-mail: odoma42@yahoo.com</p>

			<p>Accepted 25 April, 2016</p>
		...
		<p>
<b>Keywords:</b> Democracy, Ethnic, Government, Militia, Principles, Rights.
</p>

<p>
Read:  <a style="color:blue;" target="_blank" class="listjornal" href="../../../pdf/2016/april/Odoma.pdf"> [Full Text - PDF] </a>
</p>
		</div>
