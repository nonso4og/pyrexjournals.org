...
<meta property="og:title" content="Submit Manuscript to PJPSIR" />
<meta property="og:description" content="Submit manuscript to Pyrex Journal Of Political Science And International Relations " />
<meta property="og:url" content="http://www.pyrexjournals.org/pjpsir/index.php" />
...
<title>Submit Manuscripts | PJPSIR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjpsir.jpg" width="199" height="264" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Manuscripts | PJPSIR </h1>
			<br />
			<p>
...
<p>
Submit manuscripts as an e-mail attachment to the editorial office at:<span style="color:blue;"> pjpsir@pyrexjournals.org</span>
</p>
...
<p>
Kindly ensure that the citation in the body of your manuscript should be in-text reference citations and not number citation? For example, kidney transplat (Charles, 2004; Boton and Chaton, 1999) showed that a minimum of 24-hour is needed… James and Greg (2008) revealed that. 
</p>
