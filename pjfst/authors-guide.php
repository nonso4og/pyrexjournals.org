...
<title>Author's Guide | PJFST</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJFST</a></div>
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjfst.jpg" width="200" height="260" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJFST </h1>
			<br />
			<p>
			<b>Pyrex Journal of Food Science and Technology </b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of Pyrex Journal of Food Science and Technology  including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
		...
		<p>
Food chemistry, food engineering, food microbiology, food packaging, food preservation, food safety, food technology, molecular gastronomy, new product development, sensory analysis, etc.
		</p>
...
<p>
Pyrex Journal of Food Science and Technology will only accept manuscripts submitted as e-mail attachments.
</p>
