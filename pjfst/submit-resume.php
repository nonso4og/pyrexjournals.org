...
<title>Submit Resume | PJFST</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Resume | PJFST</h1>
			<br />
			<p>
			 Pyrex Journal of Food Science and Technology is seeking energetic, qualified and high profile researchers to join its editorial team as editors, subeditors or reviewers. Kindly send your resume by using our online form below:
			</p>
