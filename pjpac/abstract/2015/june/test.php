...
<body>
	...
	<div class="main-body-wrapper">
		...
		<h1 style="font-size:16px; " class="box-header-blue">Pyrex Journal of Agricultural Research (PJASD)</h1>
		<p style="padding:0px; margin:0px;"><b>April 2014 Vol. 1(1), pp. 000-000</b></p>
		<p style="padding:0px; margin:0px;">Copyright © 2014 Webcrawler Journals</p>
		
		<br />
		<br />
		<br />
		
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Lenght Research Paper</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">TITLE</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Author's Name</h1>
