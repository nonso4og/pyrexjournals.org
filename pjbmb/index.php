...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">About | PJBMB </h1>
			<br />
			<p>
			<b>  Pyrex Journal Of Biotechnology and Molecular Biology </b>  is an open access academic refereed journal published monthly by Pyrex Journals.
			</p>
			
			<p>
			<b>PJBMB</b> publishes research articles that report premier fundamental discoveries and inventions, and the applications of those discoveries, unconfined by traditional discipline barriers. All articles published by <b>PJBMB</b> are published in English. 
			</p>
			
			<p>
			The objective of <b>PJBMB</b> is to publish the most significant as well as innovative articles all  areas of the journal; in other to accelerate the sharing and free-access of knowledge.
			</p>
			...
			<p>
		All articles that are submitted to this journal are made to undergo sectioning to ensure that they are in line with the scope of PJBMB and as well as the instructions for authors. Thereafter they are double-blindedly peer-reviewed by both internal and external reviewers. More than 100 reviewers are working diligently to shorten the review cycle of the academic research publication; and help researchers to pay more attention on the research itself, not waiting for too long, for suggestions from reviewers.
			</p>
			
			<p>
			To be accepted, a paper must be judged to be truly outstanding in its field and to be of interest to a wide audience. The primary criteria during the review and selection process of the submitted papers are; sound theoretical basis, valid empirical application and analysis, and contribution to the fields of Biotechnology and Molecular Biology. The primary criteria in the final selection of the papers once the review process is complete are quality, originality, and relevance to the international fields of the journal.
			</p>
 

			<h1 style="font-size:18px; " class="box-header-blue">Copyright</h1>
<p>
Copyright is a major issue for PJBMB. Manuscript submission and their accessibility is not an infringement of copyright. All articles in PJBMB remain the property of their authors.
</p>
