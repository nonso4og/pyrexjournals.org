...
<title>Submit Manuscripts | PJBMB</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjbmb.jpg" width="199" height="264" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Manuscripts | PJBMB </h1>
			<br />
			<p>
...
<p>
Submit manuscripts as an e-mail attachment to the editorial office at:<span style="color:blue;"> pjbmb@pyrexjournals.org</span>
</p>
