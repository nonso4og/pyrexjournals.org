...
<title>Author's Guide | PJEMT</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJEMT</a></div>
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjemt.jpg" width="200" height="260" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJEMT</h1>
			<br />
			<p>
			<b>Pyrex Journal of Engineering and Manufacturing Technology </b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of Engineering and Manufacturing Technology  including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
		...
		<h1 style="font-size:18px; " class="box-header-blue">a. Material Science</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">b. Civil Engineering</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">c. Chemical Engineering</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">d. Mechanical Engineering</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">e. Electrical and Electronic Engineering</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">f. Marine/Ocean Engineering</h1>	
<p>
...
<p>
Donnish Journal of Engineering and Manufacturing Technology will only accept manuscripts submitted as e-mail attachments.
</p>
