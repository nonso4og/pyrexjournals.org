...
<title>Submit Resume | PJCRO</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Resume | PJCRO</h1>
			<br />
			<p>
			  Pyrex Journal of Clinical Reviews and Opinions is seeking energetic, qualified and high profile researchers to join its editorial team as editors, subeditors or reviewers. Kindly send your resume by using our online form below:
			</p>
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
   ...
   if(empty($_POST['name']) || empty($_POST['title']) || empty($_POST['institution']) || empty($_POST['specialisation'])  || empty($_POST['email']) || empty($_POST['task']))
	{
