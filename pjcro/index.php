...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; c" class="box-header-blue">About | PJCRO</h1>
			<br />
			<p>
			<b>Pyrex Journal of Clinical Reviews and Opinions </b>is an open access academic refereed journal published monthly by Pyrex Journals.
			</p>
			
			<p>
			<b>PJCRO</b> publishes research articles that report premier fundamental discoveries and inventions, and the applications of those discoveries, unconfined by traditional discipline barriers. All articles published by <b>PJCRO</b> are published in English. 
      </p>
			
			<p>
			The objective of <b>PJCRO</b> is to publish the most significant as well as innovative articles all areas Clinical Reviews and Opinions; in other to accelerate the sharing and free-access of knowledge.
		  </p>
...
<p>
Copyright is a major issue for PJCRO. Manuscript submission and their accessibility is not an infringement of copyright. All articles in PJCRO remain the property of their authors.
</p>
...
<p>
The contents of published articles represent solely the ideas of authors. Editors as well as Board of Editors of PJCRO are not responsible for the views expressed by authors. However, the Editorial Board of PJCRO takes responsibility for making publication decisions for submitted manuscripts based on the reviewer’s evaluation of the manuscript, policies of the journal Editorial Board and legal restrain acting against plagiarism, libel and copyright infringement.
</p>		
	<br />
	<br />
