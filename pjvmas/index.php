...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; c" class="box-header-blue">About | PJVMAS</h1>
			<br />
			<p>
			<b>Pyrex Journal of Veterinary Medicine and Animal Science </b>is an open access academic refereed journal published monthly by Pyrex Journals.
			<b>(2985-881X)</b></p>
			
			<p>
			<b>PJVMAS</b> publishes research articles that report premier fundamental discoveries and inventions, and the applications of those discoveries, unconfined by traditional discipline barriers. All articles published by <b>PJVMAS</b> are published in English. 
    </p>
			
			<p>
			The objective of <b>PJVMAS</b> is to publish the most significant as well as innovative articles all areas Veterinary Medicine and Animal Science; in other to accelerate the sharing and free-access of knowledge.
		  </p>
...
<p>
Copyright is a major issue for PJVMAS. Manuscript submission and their accessibility is not an infringement of copyright. All articles in PJVMAS remain the property of their authors.
</p>
...
<p>
The contents of published articles represent solely the ideas of authors. Editors as well as Board of Editors of PJVMAS are not responsible for the views expressed by authors. However, the Editorial Board of PJVMAS takes responsibility for making publication decisions for submitted manuscripts based on the reviewer’s evaluation of the manuscript, policies of the journal Editorial Board and legal restrain acting against plagiarism, libel and copyright infringement.
</p>		
	<br />
	<br />
