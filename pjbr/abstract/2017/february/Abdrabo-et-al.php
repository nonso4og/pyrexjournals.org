...
<title>Serum Magnesium and Copper levels were associated with Ambulation in Type 2 Diabetic Patients</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>February 2017 Vol. 3 (2), pp. 7-11</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Serum Magnesium and Copper levels were associated with Ambulation in Type 2 Diabetic Patients</h1>
			
	    <br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Abo-Baker Mohammed Al-Amin<sup>1</sup>, Khalid Gindeel Abu-Baker<sup>2</sup> and AbdElkarim A. Abdrabo<sup>1*</sup></h1>
			<p><sup>1</sup>Department of Chemistry, Faculty of Medical laboratory Sciences, Al-Neelain University, Sudan.</p>
			<p><sup>2</sup>Elrhyada Medical Complex, Clinical Laboratory Service, Portsudan, Sudan.</p>
		...
		<p>
<b>Keywords:</b> Type 2 DM, Magnesium, Copper, HbA1c, Amputation.</p>

<p>
Read:  <a style="color:blue;" target="_blank" class="listjornal" href="../../../pdf/2017/february/Abdrabo-et-al.pdf"> [Full Text - PDF] </a>
</p>
		</div>
