...
<title>Assessment of Prolactin Level Among Sudanese Psychiatric Subjects</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>February 2017 Vol. 3 (2), pp. 12-16</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Assessment of Prolactin Level Among Sudanese Psychiatric Subjects</h1>
			
	    <br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Nidal Rabih Mohamed*, Rimaz A. Qurashi and AbdElkarim A. Abdrabo</h1>
			<p>Department of clinical chemistry, Faculty of Medical Laboratory Science, Al-Neelain University, Sudan.</p>
