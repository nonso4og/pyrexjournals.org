...
<title>Submit Resume | PJBR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Resume | PJBR</h1>
			<br />
			<p>
			  Pyrex Journal of Biomedical Research is seeking energetic, qualified and high profile researchers to join its editorial team as editors, subeditors or reviewers. Kindly send your resume by using our online form below:
			</p>
