...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, January 2017 | PJBR </h1>
			<br />
			<h3>Full Length Research Paper </h3>


            <p style="line-height:20px;">
			<b>Effects of Antipsychotic Drugs on Serum Biochemical Tests</b>
			<br />

			Maha Makeen, Joiria Abdelraheem, Shiraz Osman, Eman Abass, Khalid M. Adam and AbdElkarim A. Abdrabo*

			<br />
			Pyrex Journals Bio. Res. January 2016 3(1): 1-6
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2017/january/Abdrabo-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2017/january/Abdrabo-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
