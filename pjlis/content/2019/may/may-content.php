...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, May 2019 | PJLIS </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>Perceptions and use of Library Resources among Undergraduate Students in an African University of Science and Technology</b>
			<br />

			                       Omonigho Angela Israel
			<br />
			Pyrex Journals Lib. Inf. Sci. May 2019 4(1): 1-12 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2019/may/Israel.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2019/may/Israel.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
			<br />
			<br />
