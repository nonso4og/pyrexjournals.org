...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, June 2015 | PJNAM </h1>
			<br />
			<h3>Original Research Article</h3>
			
			<p style="line-height:20px;">
			<b>The predictive value of Endothelin-1 and histopathological changes during acute and chronic myocardial infarction in human and rat</b>
			<br />

			                       MH Hammadi<sup>1</sup>, NM luaibi<sup>1*</sup> and SR Hamoodi<sup>2</sup>
			<br />
			Pyrex Journals Nut. And. Met. June 2015 1(2): 006-013 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/june/luaibi-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/june/luaibi-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
