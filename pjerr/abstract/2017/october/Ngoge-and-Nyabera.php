...
<title>A Comparative Study of Media Content in Print and online ‘Daily Nation’ Newspaper in Kenya</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="../../../submit-manuscripts.php"><img  src="../../../../images/cover-pjerr-112.jpg" width="200" height="260" /></a>
		...
		<p style="padding:0px; margin:0px;"><b>October 2017 Vol. 3(4), pp. 28-39</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">A Comparative Study of Media Content in Print and online ‘Daily Nation’ Newspaper in Kenya</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Geoffrey T Ngoge* and Samwel N. Nyabera</h1>

			<p>School of Information, Communication and Media Studies, Rongo University, PO Box 103-40404, Rongo, Kenya.</p>

			<p>Corresponding Author E-mail: s.nyabera@gmail.com</p>

			<p>Accepted 2nd October, 2017 </p>
...
<p><b>Keywords:</b> Online, Media, Newspaper, Content, Media Dependency.
		...
		<p>
Read:  <a style="color:blue;" target="_blank" class="listjornal" href="../../../pdf/2017/october/Ngoge-and-Nyabera.pdf"> [Full Text - PDF] </a>
</p>
		</div>
