...
<title>Submit Resume | PJERR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue">Submit Resume | PJERR</h1>
			<br />
			<p>
			  Pyrex Journal of Educational Research and Reviews is seeking energetic, qualified and high profile researchers to join its editorial team as editors, subeditors or reviewers. Kindly send your resume by using our online form below:
			</p>
