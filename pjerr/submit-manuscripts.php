...
<title>Submit Manuscripts | PJERR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | DJERR</a></div>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Manuscripts | PJERR</h1>
			<br />
			<p>
...
<p>
Submit manuscripts as an e-mail attachment to the editorial office at:<span style="color:blue;"> pjerr@pyrexjournals.org</span>
</p>
