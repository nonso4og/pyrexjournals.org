...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, August 2015 | PJDOH </h1>
			<br />
			<h3>Original Research Article</h3>
			
			<p style="line-height:20px;">
			<b>Esthetic Rehabilitation with Porcelain Laminates in Periodontally Compromised Teeth</b>
			<br />

			                       A Khiari<sup>*1</sup>, D Hadyaoui<sup>2</sup>, J Saâfi<sup>2</sup>, H Harzallah<sup>2</sup> and M Cherif<sup>2</sup>
			<br />
			Pyrex Journals Den. Ora. Hyg. August 2015 1(3): 024-028 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/august/khiari-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/august/khiari-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
