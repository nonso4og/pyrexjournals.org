...
<title>Publication Ethics | PJDOH</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Publication Ethics | PJDOH </h1>
			<br />
			<p>
		<b> Pyrex Journal Of Dentistry And Oral Hygiene </b> 	holds the ethics of publication as one of its core values and as such, adheres strictly to internationally accepted publication ethics. To ensure compliance, <b>PJDOH</b> employs the double-blinded peer-review process for all articles she reviews. The rationale for <b>PJDOH</b> double-blinded peer review process is to validate the integrity and novelty of the research work. Peer review process adopted by <b>PJDOH</b> acts as filter and increases the quality of research submitted for publication. This process also help the authors to remove any errors or gaps in manuscript mistakenly overlooked and assists in making the research more applicable in real time.
			</p>
			
			<p>
			Pyrex Journal Of Dentistry And Oral Hygiene adopts the <a href="http://publicationethics.org/" target="_blank">COPE</a> guidelines on publication ethics.
			</p>
