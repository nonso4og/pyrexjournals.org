...
<title>Author's Guide | PJMBR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjmbr.jpg" width="200" height="260" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJMBR </h1>
			<br />
			<p>
			<b>PyrexJournal of Microbiology and Biotechnology Research </b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of microbiology and biotechnology Research  including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
		...
		<h1 style="font-size:18px; " class="box-header-blue">a. Microbiology</h1>
		<p>
Bacteriology, Biotechnology, Cell Physiology, Clinical Microbiology, Entomology, Environmental Biotechnology, Environmental Microbiology, Food Microbiology, Genetics, Immunology, Industrial Microbiology, Medical Microbiology, Microbial Biochemistry, Microbial Ecology, Microbial Probiotics and Prebiotics, Cellular Biology, Molecular Microbiology, Mycology, Parasitology, Phycology, Plant Pathology, Protozoology, Soil and Environmental Sciences, Soil Microbial Studies, Toxicology, Virology, Zoology, etc. 
		...
		<h1 style="font-size:18px; " class="box-header-blue">b. Biotechnology</h1>
		<p>
...
<p>
Pyrex Journal of Microbiology and Biotechnology Research will only accept manuscripts submitted as e-mail attachments.
</p>
