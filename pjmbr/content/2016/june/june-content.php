...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, June 2016 | PJMBR </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>The Microbiological and Physicochemical Properties of Some Crude Oil Contaminated and Uncontaminated Agricultural Soils in Ondo State, Nigeria</b>
			<br />

			                       Ikuesan, Felix Adeleke*, Boboye, Bolatito Esther and Adetuyi, Fatusa Clement
			<br />
			Pyrex. Journal. Microbiol. Biotechnol. Res. June 2016 2(1): 1-8 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2016/june/Ikuesan-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2016/june/Ikuesan-et-al.pdf" target="_blank"> [Full Text - PDF] </a></p>
