...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; c" class="box-header-blue">About | PJEN</h1>
			<br />
			<p>
			<b>Pyrex Journal of Entomology And Nematology </b>is an open access academic refereed journal published monthly by Pyrex Journals.
			</p>
			
			<p>
			<b>PJEN</b> publishes research articles that report premier fundamental discoveries and inventions, and the applications of those discoveries, unconfined by traditional discipline barriers. All articles published by <b>PJEN</b> are published in English. 
  </p>
			
			<p>
			The objective of <b>PJEN</b> is to publish the most significant as well as innovative articles all areas of Entomology And Nematology; in other to accelerate the sharing and free-access of knowledge.
		  </p>
...
<p>
Copyright is a major issue for PJEN. Manuscript submission and their accessibility is not an infringement of copyright. All articles in PJEN remain the property of their authors.
</p>
...
<p>
The contents of published articles represent solely the ideas of authors. Editors as well as Board of Editors of PJEN are not responsible for the views expressed by authors. However, the Editorial Board of PJEN takes responsibility for making publication decisions for submitted manuscripts based on the reviewer’s evaluation of the manuscript, policies of the journal Editorial Board and legal restrain acting against plagiarism, libel and copyright infringement.		
	<br />
	<br />
	  </p>
		</div>
