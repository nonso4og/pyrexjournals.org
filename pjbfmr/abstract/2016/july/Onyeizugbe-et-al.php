...
<title>Ambidexterity and Employee Performance of Selected Commercial Banks in Anambra State of Nigeria</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>July 2016 Vol. 2(7), pp. 58-64</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Ambidexterity and Employee Performance of Selected Commercial Banks in Anambra State of Nigeria</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Onyeizugbe Chinedu U*, Orogbu Obiageli L and Asiegbu Onyinye B</h1>

			<p>Department of Business Administration Nnamdi Azikiwe University, P.M.B. 5025, Anambra State, Nigeria.</p>

			<p>Corresponding Author E-mail: edu_phd@yahoo.com</p>

		  <p>Accepted 11th July, 2016</p>
