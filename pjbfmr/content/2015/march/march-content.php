...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, March 2015 | PJBFMR </h1>
			<br />
			<h3>Original Research Article</h3>
			
			<p style="line-height:20px;">
			<b>The impact of Performance evaluation measures and strategic analysis on Auditors' risk assessments</b>
			<br />

			Fatemeh Baghiyan
			<br />
			Pyrex Journals Bus. Fin. Man. Res March 2015 1(1): 001-005 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/march/fatemeh.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/march/fatemeh.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
			<br />
			<br />
