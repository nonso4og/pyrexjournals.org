...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, October 2015 | PJBFMR </h1>
			<br />
			<h3>Original Research Article</h3>
			
			<p style="line-height:20px;">
			<b>Clarification on Transfer Price Charged in Brasil</b>
			<br />

			Carlos Antonio Da Silva Moura
			<br />
			Pyrex Journals Bus. Fin. Man. Res. October 2015 1(3): 016-022 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/october/moura.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/october/moura.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
			<br />
			<br />
