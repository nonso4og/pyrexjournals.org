...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">2016 Content | PJBFMR </h1>
			<br />
			<table class="table-archives" align="center">
				<tr>
					<td><a href="january/january-content.php">January</a></td>
					<td><a href="february/february-content.php">February</a></td>
					<td><a href="march/march-content.php">March</a></td>
					<td><a href="april/april-content.php">April</a></td>
				</tr>
				
					<tr>
					<td><a href="may/may-content.php">May</a></td>
					<td><a href="june/june-content.php">June</a></td>
					<td><a href="july/july-content.php">July</a></td>
					<td><a href="#">-</a></td>
				</tr>
				
					<tr>
					<td><a href="september/september-content.php">September</a></td>
					<td><a href="october/october-content.php">October</a></td>
					<td><a href="#">-</a></td>
					<td><a href="december/december-content.php">December</a></td>
				</tr>
