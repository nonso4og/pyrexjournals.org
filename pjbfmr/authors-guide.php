...
<title>Author's Guide | PJBFMR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjbfmr.jpg" width="200" height="260" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJBFMR</h1>
			<br />
			<p>
			<b>Pyrex Journal of Business and Finance Management Research </b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of Business and Finance Management Research including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
		...
		<h1 style="font-size:18px;" class="box-header-blue">a. Business Management Research</h1>
<p>
...
<h1 style="font-size:18px;" class="box-header-blue">b. Finance Management Research</h1>
<p>
...
<p>
Pyrex Journal of Business and Finance Management Research will only accept manuscripts submitted as e-mail attachments.
</p>
