...
<meta property="og:url" content="http://www.pyrexjournals.org/unsubscribe.php/" />
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			<h1 style="font-size:20px; " class="box-header-blue">Unsubscribe To Our Newsletter</h1>
			<br />
			
			<p>
			If you wish to stop receiving emails from us, kindly submit the form below. 
			</p>
			<br />
...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Unsubscribe To Newsletter";
...
?>
			<form name="contactform" method="post" action="newsletter-delete.php">
