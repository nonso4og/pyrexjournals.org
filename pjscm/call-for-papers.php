...
<title>Call For Papers | PJSCM</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Call For Papers | PJSCM </h1>
			<br />
			<p>
			 Pyrex Journal Of Supply Chain Management publishes scientific articles (monthly) in all areas of the journal that are not under consideration for publication elsewhere in our open access journals
			 </p>

<p>
The Journal welcomes the submission of manuscripts that meets the general criteria of significance and scientific excellence. Papers will be published approximately two (2) weeks after acceptance. All articles published in PJSCM will be peer-reviewed.
</p>

<p>
Pyrex Journal Of Supply Chain Management will be publish monthly (one volume per year) by Pyrex Journals.
</p>
