...
<title>Author's Guide | PJSCM</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="slider_container">
				<ul class="rslides">
					<li><img src="../images/pjscm.jpg" width="960" height="200" /></li>
				</ul>
	</div>

	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJSCM</a></div>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJSCM </h1>
			<br />
			<p>
...
<p>
In preparing manuscripts, authors are required to follow the “Guide for Authors” that is presented at the journals home page.  Submitted papers should not have been

previously published nor be currently under consideration for publication elsewhere.

Manuscripts will be refereed according to PJSCM normal standards and procedures.</p>
 
<p>
Manuscript(s) should be submitted as e-mail attachment to the Editorial Office at:<span style="color:blue;"> pjscm@pyrexjournals.org</span>. Acknowledgement letter(s) together with manuscript number(s) will be mailed to the corresponding author within 48 hours of manuscript(s) reception by the Editorial Office.</p>
...
<p>
Pyrex Journal of  Supply Chain Management will only accept manuscripts submitted as e-mail attachments.
</p>
