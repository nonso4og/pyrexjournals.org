...
<title>Author's Guide | PJOMS</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="slider_container">
				<ul class="rslides">
					<li><img src="../images/pjoms.jpg" width="960" height="200" /></li>
				</ul>
	</div>

	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJOMS</a></div>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJOMS </h1>
			<br />
			<p>
			<b>Pyrex Journal Of Oceanography And Marine Science </b>welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of the Journal including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
