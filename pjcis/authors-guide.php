...
<title>Author's Guide | PJCIS</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="slider_container">
				<ul class="rslides">
					<li><img src="../images/pjcis.jpg" width="960" height="200" /></li>
				</ul>
</div>

	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJCIS</a></div>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJCIS </h1>
			<br />
			<p>
			<b>Pyrex Journal of Computer and Information Systems</b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of microbiology and biotechnology Research  including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
		...
		<p>
Biochemistry/biophysics, cell biology, developmental biology, genetics, immunology, microbiology, molecular biology, protein science, structural biology, and translational medicine etc.
		</p>
...
<p>
Pyrex Journal of Computer and Information Systems will only accept manuscripts submitted as e-mail attachments.
</p>
...
<p>
Authors are required to pay a $400 processing fee. Publication of an article in the Pyrex Journal of Computer and Information Systems is not contingent upon the author's ability to pay the charges. Neither is acceptance to pay the processing fee a guarantee that the paper will be accepted for publication. Authors may still request (in advance) that the editorial office waive some of the processing fee under special circumstances.</p>		
	<br />
	<br />
