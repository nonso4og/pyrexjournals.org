...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, February 2019 | PJPAR </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>Study of Chemical Composition of Cattle Meat and Sheep Meat in Khartoum State</b>
			<br />

			Siham Abdelwhab*, Fatima Jamal and Fatima Osman<br />
			J Plant. Agric. Res. February 2019 4(1): 1-5
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2019/february/Abdelwahab-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2019/february/Abdelwahab-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
