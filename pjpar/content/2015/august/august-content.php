  ...
  <div class="top-menu-container">
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, August 2015 | PJPAR </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>A study in mineral composition of camel meat and beef</b>
			<br />

			Siham, A. A., Elshafia, S. A. and Huda, M. Z.
			<br />
			Pyrex Journals Agr. Res. August 2015 1(3): 014-019 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/august/siham-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/august/siham-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
