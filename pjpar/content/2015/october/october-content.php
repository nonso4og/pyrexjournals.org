  ...
  <div class="top-menu-container">
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, October 2015 | PJPAR </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>Morphological Characterization and Yield Evaluation of Sweetpotato Landraces for Genetic Recombination</b>
			<br />

			I.I. M Nwankwo*, E.O. Ekah and  C.J. Eluagu
			<br />
			Pyrex Journals Agr. Res. October 2015 1(4): 020-025
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2015/october/nwankwo-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2015/october/nwankwo-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
