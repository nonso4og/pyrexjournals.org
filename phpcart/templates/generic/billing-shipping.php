				...
				<td width="50%" valign="top">
					...
					<table width="100%" class="infobox" cellpadding="5">
						...
						<tr height="55px">
							...
							<td align="left">
                           <input name="shippingsame" type="checkbox" class="cartform" value="Y" onchange="setshipping();" %%SHIPPINGSAMECHECKED%%> Shipping is same as billing
						...
						<tr>
							...
							<td align="left">State Other<br>
								...
								<input name="sstateother" type="text" class="cartform" id="sstateother" value="%%SSTATEOTHER%%" size="15" maxlength="30">
