      ...
      <tr>
        ...
        <table width="758"  height="47"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="38%" align="left" bgcolor="#FF9933" class="username"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="236" valign="top" scope="col">
                ...
                <tr class="infobox">
                  ...
                  <td align="right" valign="middle" class="text">%%TOTALSHIPPING%% &nbsp;</td>
			...
			<table width="100%">
                 ...
                 <tr>
                    ...
                    <td width="33%" align="center" scope="col"><!-- BEGIN EMPTY -->&nbsp;<a href="?action=checkout">Checkout</a><img src="%%TEMPLATEPATH%%images/arrow.gif" width="11" height="11"><!-- END EMPTY -->&nbsp;
                    </td>
