...
-->
	...
	<tr>
	    <td colspan="2"><em><font size="4" face="Geneva, Arial, Helvetica, sans-serif">Web Order Cancelled</font></em></td></tr>
	<tr><td width="20%">
    ...
    <!-- BEGIN ORDERLINK -->
    <p align="center"><a href="%%CartPath%%/orders/display_order.php?order=%%ORDERID%%">You can see a copy of the order here</a></p>
    <!-- END ORDERLINK -->
