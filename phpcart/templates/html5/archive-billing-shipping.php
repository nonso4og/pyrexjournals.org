					...
					<table width="100%" class="infobox" cellpadding="5">
						...
						<tr height="55px">
							<td align="left">
                            	Shipping is same as billing<br />
                           		<input name="shippingsame" type="checkbox" value="Y" onchange="setshipping(); updateShipping();" %%SHIPPINGSAMECHECKED%%> 
                            </td>
						</tr>
						...
						<tr>
							<td align="left">
								...
								<input name="sstateother" type="text" class="cartform" id="sstateother" value="%%SSTATEOTHER%%" onchange="updateShipping()">
