...
if (isset($_POST['Submit'])){
	...
	$thelink .= "&quantity=1&key=$key\">".trim($_REQUEST["link_text"])."</a>\n";
...
<p align="center" class="page_title"><a href="button_maker.php?option=1">Click Here to Generate Another Link</a></p>
