...
<p align="center" class="page_title"><b>Hyperlink Button</b></p>

<form action="button_maker.php?option=5" method="post">
<input type="hidden" name="token" value="<?php echo $token; ?>" />

<table border="0" cellspacing="4" cellpadding="1" width="600">

<tr>
    <td width="300" class="form_label"><b>Path to phpCart:</b></td><td width="300"><input type="text" name="pth" value="<?php echo $pth; ?>" size=35>
...
<tr>
<td class="form_label"><b>Link Text:&nbsp;&nbsp;&nbsp; <br />
</b>(e.g. Add to Cart)</td><td><input type="text" name="link_text" value="Add to Cart!" size=35></td></tr>
