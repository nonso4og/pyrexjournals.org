...
<table border='1' cellpadding='0' cellspacing='4' width='100%'>
	<tr>
		<td width='100%' colspan="2">Net1:</td>
	</tr>
	<tr>
		<td width='59%'>Merchant ID:</td>
		<td width='41%'><input type='text' name='modulenet1_merchantid' size='15' value='<?php echo $PROCESSOR["modulenet1_merchantid"]; ?>'></td>
	</tr>
</table>
<br>
<?php
...
function Checkoutnet1($products, $totals, $orderid, $billing){
...
<input type="hidden" name="M_id" value="<?php echo $PROCESSOR["modulenet1_merchantid"]?>">
