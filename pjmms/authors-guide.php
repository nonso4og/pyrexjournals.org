...
<title>Author's Guide | PJMMS</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			<div class="box-menu"><a class="listjornaled" href="index.php">Home | PJMMS</a></div>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue">Author's Guide | PJMMS </h1>
			<br />
			<p>
			<b>Pyrex Journal of  Medicine and Medical Sciences  </b>   welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of medicine and medical sciences including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
			...
			<h1 style="font-size:18px; " class="box-header-blue">a. General Medicine</h1>
			
			<p>
Addictive Diseases, Antibody Therapy, Application of Medical, Surgical, Public Health, Dental, Diagnostic and Therapeutic Principles to Non-human Animals, Biomedical Engineering, Cancer Prevention, Cardiovascular Research, Chemotheraphy, Clinical Cancer Research, Clinical Cardiovascular Research, Clinical Chemistry And Biochemistry, Clinical Endocrinology, Clinical Immunology and Immunopathology, Clinical Pathophysiology, Clinical Pharmacology, Congenital Disorders, Dentistry, Dermatology, Diagnostic, Geriatrics and Sport Medicine, Experimental Cancer Research, Ethology, Forensic Pathology, Gynaecology, Hormone Therapy, Hypoglycemia in Diabetes, Infectious Diseases, Internal Medicine, Mammography, Neuroendocrinology, Neurology, Neurophysiology and Brain Research, Nutritional Research, Ophthalmology, Otorhinolaryngology, Pediatrics, Pathology, Psychosomatic Diseases, Psychiatry, Physiology, Public Health, Radiobiology, Respiratory Diseases, Surgery, Tropical Medicine, Tuberculosis and Vitaminology, etc.
			</p>
			
			<h1 style="font-size:18px; " class="box-header-blue">b. Social Medicine</h1>
 
 			<p>
			Antiretroviral Therapy, Comparative Tolerability, Dietetics, Environmental Toxicology, Ergonomy, Gender-Based HIV and AIDS Prevention Interventions, Group Medicine, Health Education, Health Services and Medical Statistics, HIV and Sexual Risk Behaviours, Medico-Social Problems of the Elderly, Medico-Social Problems of the Youth, Occupational Medicine, Rehabilitation, Human Ecology, Social Paediatrics, etc. 
			</p>

<h1 style="font-size:18px; " class="box-header-blue">Submission of Manuscript</h1>
<p>
Submission of manuscript(s) should be by electronic submission with the text, tables and figures included in a single Microsoft Word file (preferably in Times New Roman or Arial font with font size 12). However, where it is not convenient for the author to include some tables and/or figures in the text of the manuscript, such tables or figures may be placed in a separate Microsoft Word file together with their figure legends. Their position should be properly cited/indicated in the text to enable the Editorial Office of PJMMS, affix them appropriately, when editing the article during processing of the manuscript(s). All pages should be numbered consecutively starting from the title page.
</p>
 
<p>
Manuscript(s) should be submitted as e-mail attachment to the Editorial Office at:<span style="color:blue;"> pjmms@pyrexjournals.org</span>. Acknowledgement letter(s) together with manuscript number(s) will be mailed to the corresponding author within 48 hours of manuscript(s) reception by the Editorial Office.
</p>
 

<h1 style="font-size:18px; " class="box-header-blue">Cover Letter</h1>
<p>
...
<br /> 
<ul style='padding:0px; margin-left:12px; font-family:Georgia, "Times New Roman", Times, serif; font-size:14px; text-align:justify; color:#000000;'>
<li>       the research article is original and has not been submitted or accepted for publication elsewhere;</li>

<li>clearly indicates whether potential conflict(s) of interest(s) do or do not exist;</li>

<li>the manuscript has been read and approved by all the authors.</li>
</ul>
</p> 

<p>
Pyrex Journal of Medicine and Medical Sciences will only accept manuscripts submitted as e-mail attachments.
</p>
 

<h1 style="font-size:18px; " class="box-header-blue">Manuscript(s) Arrangement</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Title</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Names of Author(s)</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Authors’ Affiliation(s)</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Abstract</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Key words</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Text</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Introduction</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Materials and Methods</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Results and Discussion</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Acknowledgement (Optional)</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">References</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Paper in a Journal</h1>
<p>
Obaro S (2009). Seven-valent pneumococcal conjugate vaccines for developing countries. Expert Rev. Vaccin. 8:1051-1061.
<br />
Bronte V and Zanovello P (2005). Regulation of immune responses by Larginine metabolism. Nat. Rev. Immunol. 5:641–654.
<br />
...
<h1 style="font-size:18px; " class="box-header-blue">Book</h1>
<p>
Harbourne JB (1973). Phytochemical Methods. Chapman & Hall, ltd, London 188p.
</p>
 

<h1 style="font-size:18px; " class="box-header-blue">Chapter in a Book</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Electronic Sources</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Tables and Figures</h1>
<p>
...
<h1 style="font-size:18px; " class="box-header-blue">Fees and Charges</h1>
<p>
Authors are required to pay a $400 processing fee. Publication of an article in the Pyrex Journal of Medicine and Medical Sciences  is not contingent upon the author's ability to pay the charges. Neither is acceptance to pay the processing fee a guarantee that the paper will be accepted for publication. Authors may still request (in advance) that the editorial office waive some of the processing fee under special circumstances. 
	</p>		
	<br />
	<br />
