...
<title>Changing Pattern of Mechanical Bowel Obstruction and Management Outcome in North-Eastern Nigeria</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>September 2017 Vol. 4 (4), pp. 18-20</b></p>
		...
		<h1 style="font-size:16px; font-style:italic; font-weight:600; color:#333333;" class="box-header-blue">Review Paper</h1>
			...
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Changing Pattern of Mechanical Bowel Obstruction and Management Outcome in North-Eastern Nigeria</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">S Aliyu*, MB Tahir, UD Babayo, AB Zarami, AG Ibrahim and AG Madziga</h1>
...
Department of Surgery and Histopathology, University of Maiduguri Teaching Hospital Maiduguri, Borno State, Nigeria.
			...
			<p>Corresponding Author E-mail: <span style="color:blue;">drsuleiman.aliyu@yahoo.com</span></p>
...
<p>
<b>Keywords:</b> Mechanical bowel obstruction, Changing pattern, Management outcome.
</p>

<p>
Read:  <a style="color:blue;" target="_blank" class="listjornal" href="../../../pdf/2017/september/Aliyu-et-al.pdf"> [Full Text - PDF] </a>
</p>
