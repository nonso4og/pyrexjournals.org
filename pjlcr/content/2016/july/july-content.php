...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, July 2016 | PJLCR </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>Globalization and Terrorism: Corruption as a Case to Ponder</b>
			<br />

			Sunday Bobai Agang
			<br />
			Pyrex Journals Law. Con. Res. July 2016 2(1): 1-8
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2016/july/Agang.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2016/july/Agang.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
