...
<title>Author's Guide | PJLCR</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Author's Guide | PJLCR </h1>
			<br />
			<p>
			<b>Pyrex Journal Of Law And Conflict Resolution </b>welcomes submissions of articles which are to be considered for monthly publication in the journal; such as Communications, Reports of preliminary research findings that justify urgent publication, Full research articles, Review articles in all areas of the Journal including Critical reviews, Mini reviews and Tutorial reviews.
			</p>
