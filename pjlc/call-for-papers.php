...
<title>Call For Papers | PJLC</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue">Call For Papers | PJLC</h1>
			<br />
			<p>
			<b>Pyrex Journal of Languages And Culture  </b> publishes scientific articles (monthly) in all areas of Languages And Culture that are not under consideration for publication elsewhere in our open access journals
			 </p>

<p>
The Journal welcomes the submission of manuscripts that meets the general criteria of significance and scientific excellence. Papers will be published approximately two (2) weeks after acceptance. All articles published in PJLC will be peer-reviewed.
</p>

<p>
<b>Pyrex Journal of Languages And Culture</b> will be publish monthly (one volume per year) by Pyrex Journals.
</p>
