...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; c" class="box-header-blue">About | PJLC</h1>
			<br />
			<p>
			<b>Pyrex Journal of Languages And Culture </b>is an open access academic refereed journal published monthly by Pyrex Journals.
			</p>
			
			<p>
			<b>PJLC</b> publishes research articles that report premier fundamental discoveries and inventions, and the applications of those discoveries, unconfined by traditional discipline barriers. All articles published by <b>PJLC</b> are published in English. 
</p>
			
			<p>
			The objective of <b>PJLC</b> is to publish the most significant as well as innovative articles all areas of Languages And Culture; in other to accelerate the sharing and free-access of knowledge.
		  </p>
...
<p>
Copyright is a major issue for PJLC. Manuscript submission and their accessibility is not an infringement of copyright. All articles in PJLC remain the property of their authors.
</p>
