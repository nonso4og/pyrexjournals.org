...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, July 2016 | PJASD </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>African Humanism as a Socialist Solution to the Capitalist Underdevelopment Problems in Nigeria: A Philosophical Appraisal</b>
			<br />

			Macaulay A. Kanu
			<br />
			Pyrex Journal Afric. Std. Dev. July 2016 2(1): 1-7 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2016/july/Macaulay.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2016/july/Macaulay.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
