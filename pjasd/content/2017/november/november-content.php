...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px;" class="box-header-blue"> Table Of Content, November 2017 | PJASD </h1>
			<br />
			<h3>Full Length Research Paper</h3>
			
			<p style="line-height:20px;">
			<b>Mediating factors between overcrowding and adolescent antisocial behavior in Lagos, Nigeria</b>
			<br />

			Olaniyi Makinde, Kaj Björkqvist*, and Karin Österman
			<br />
			Pyrex Journal Afric. Std. Dev. November 2017 3 (3): 24-30 
                        <br />
 <a style="color:blue;" class="listjornal" href="../../../abstract/2017/november/Bjorkqvist-et-al.php">[Abstract]</a> &nbsp; <a style="color:blue;" class="listjornal" href="../../../pdf/2017/november/Bjorkqvist-et-al.pdf" target="_blank"> [Full Text - PDF] </a>
</p>
