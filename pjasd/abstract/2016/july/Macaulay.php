...
<body>
	...
	<div class="main-body-wrapper">
		...
		<p style="padding:0px; margin:0px;"><b>July 2016 Vol. 2(1), pp. 1-7</b></p>
		...
		<h1 style="font-size:16px; font-weight:600; color:#333333;" class="box-header-blue">Full Length Research Paper</h1>
			...
			<h1 style="font-size:20px; font-weight:600; color:#333333;" class="box-header-blue">African Humanism as a Socialist Solution to the Capitalist Underdevelopment Problems in Nigeria: A Philosophical Appraisal</h1>
			
			<br />
			
			<h1 style="font-size:15px; font-weight:600; color:#333333;" class="box-header-blue">Macaulay A. Kanu</h1>

			<p>Department of Philosophy and Religion, Ebonyi State University, Abakaliki, Ebonyi State, Nigeria.</p>

			<p>Corresponding Author E-mail: mackandis2007@yahoo.com</p>
		...
		<p>
<b>Keywords:</b> Humanism, culture, Africa, values.
</p>

<p>
Read:  <a style="color:blue;" target="_blank" class="listjornal" href="../../../pdf/2016/july/Macaulay.pdf"> [Full Text - PDF] </a>
</p>
		</div>
