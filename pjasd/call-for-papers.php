...
<title>Call For Papers | PJASD</title>
<script>
  $(function() {
...
<body>
	...
	<div class="main-body-wrapper">
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Call For Papers | PJASD </h1>
			<br />
			<p>
			 Pyrex Journal of African Studies and Development  publishes scientific articles (monthly) in all areas of the journal that are not under consideration for publication elsewhere in our open access journals
			 </p>

<p>
The Journal welcomes the submission of manuscripts that meets the general criteria of significance and scientific excellence. Papers will be published approximately two (2) weeks after acceptance. All articles published in PJASD will be peer-reviewed.
</p>

<p>
Pyrex Journal of African Studies and Development  will be publish monthly (one volume per year) by Pyrex Journals.
</p>
