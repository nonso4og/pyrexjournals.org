...
<meta property="og:title" content="Submit Manuscript to PJAERD" />
<meta property="og:description" content="Submit manuscript to Pyrex Journal Of Agricultural Extension And Rural Development " />
<meta property="og:url" content="http://www.pyrexjournals.org/pjaerd/index.php" />
...
<title>Submit Manuscripts | PJAERD</title>
<script>
  $(function() {
...
<gcse:search></gcse:search>
	...
	<div class="main-body-wrapper">
		<div class="content-box-one">
			...
			<br />
			<a  class="front" href="submit-manuscripts.php"><img  src="../images/cover-pjaerd.jpg" width="199" height="264" /></a>
		...
		<div class="content-box-two">
			...
			<h1 style="font-size:20px; " class="box-header-blue">Submit Manuscripts | PJAERD </h1>
			<br />
			<p>
			  Please read the Guide to Authors before submitting your manuscript. The manuscript files should be given the last name of the first author.
			</p>

<p>
Submit manuscripts as an e-mail attachment to the editorial office at:<span style="color:blue;"> pjaerd@pyrexjournals.org</span>
</p>

<p>
A manuscript number will be mailed to the corresponding author same day or within 48hours.
</p>
<p>
Kindly ensure that the citation in the body of your manuscript should be in-text reference citations and not number citation? For example, kidney transplant (Charles, 2004; Boton and Chaton, 1999) showed that a minimum of 24-hour is needed… James and Greg (2008) revealed that. 
</p>

<p>
Also ensure that the manuscript file is in Microsoft Word format with the tables and figures integrated in the manuscript body. Provide the names, titles, and affiliations of all the authors of this manuscript, in the order that they appear on the manuscript.
</p>

<p>
You can also use our online manuscript submission form below to submit your articles. 
</p>
...
<td width="85%"><input name="name" type="text" id="name" size="60" /></td>
</tr>
...
<td><input name="email" type="text" id="email" size="60" /></td>
 ...
 <tr>
   <td> <label for="tele">File Upload:</label> </td>
